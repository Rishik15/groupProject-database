...
INSERT INTO exercise (exercise_name, equipment, video_url, created_by) VALUES
  ('Hack Calf Raise',                    'sled machine',     '2ORFMoR.gif', 1),   -- 1
  ('Sled Leg Press',                     'sled machine',     '2Qh2J1e.gif', 1),   -- 2
  ('Dumbbell Front Raise',               'dumbbell',         '3eGE2JC.gif', 1),   -- 3
  ('Dumbbell Reverse Wrist Curl',        'dumbbell',         '3tAXPQ6.gif', 1),   -- 4
  ('Barbell Incline Bench Press',        'barbell',          '3TZduzM.gif', 1),   -- 5
  ('Cable Squat Curl',                   'cable',            '3XFdb1Z.gif', 1),   -- 6
  ('Dumbbell Hammer Preacher Curl',      'dumbbell',         '4dF3maG.gif', 1),   -- 7
  ('Barbell Close Grip Curl',            'barbell',          '4dUn2iv.gif', 1),   -- 8
  ('Kettlebell Pistol Squat',            'kettlebell',       '5bpPTHv.gif', 1),   -- 9
  ('Weighted Dips',                      'body weight',      '05Cf2v8.gif', 1),   -- 10
  ('Barbell Overhead Tricep Extension',  'barbell',          '5uFK1xr.gif', 1),   -- 11
  ('Smith Machine Incline Press',        'smith machine',    '5v7KYld.gif', 1),   -- 12
  ('Weighted Side Bend',                 'weighted',         '6bOA1Oi.gif', 1),   -- 13
  ('Dumbbell Upright Row',               'dumbbell',         '6cKQC5E.gif', 1),   -- 14
  ('Barbell Calf Raise',                 'barbell',          '6HiHHe0.gif', 1),   -- 15
  ('Barbell Wrist Curl',                 'barbell',          '6kSxYnw.gif', 1),   -- 16
  ('Dumbbell Tricep Extension',          'dumbbell',         '6MfS53i.gif', 1),   -- 17
  ('Dumbbell Spider Curl',               'dumbbell',         '6sMAmNv.gif', 1),   -- 18
  ('Lying Knee Twist',                   'body weight',      '6sYyrRX.gif', 1),   -- 19
  ('Lat Pulldown',                       'leverage machine', '7F1DVzn.gif', 1),   -- 20
  ('Seated Cable Row',                   'leverage machine', '7I6LNUG.gif', 1),   -- 21
  ('Dumbbell Concentration Curl',        'dumbbell',         '7inpWch.gif', 1),   -- 22
  ('Cable Decline Fly',                  'cable',            '7saC5zz.gif', 1),   -- 23
  ('Smith Machine Leg Press',            'smith machine',    '7zdxRTl.gif', 1),   -- 24
  ('Dumbbell Incline Press',             'dumbbell',         '8eqjhOl.gif', 1),   -- 25
  ('Hanging Knee Raise',                 'assisted',         '8K0w2yA.gif', 1),   -- 26
  ('Cable Curl',                         'cable',            '8oYqOt9.gif', 1),   -- 27
  ('Standing Calf Raise',                'barbell',          '8ozhUIZ.gif', 1),   -- 28
  ('Hyperextension',                     'weighted',         '8urJS9b.gif', 1),   -- 29
  ('Cable Crunch',                       'cable',            '8xUv4J7.gif', 1);   -- 30
...
-- notifications (user_id fixed to real users, apostrophe escaped)
INSERT INTO notification (user_id, type, conversation_id, reference_id, title, body, is_read) VALUES
  (2, 'chat_message',     1, 1,    'New message from Coach Sam', 'Hey coach, excited to start.',                              0),
